package Genericmethodandclass;
    ...
    public class myRunner {
        public static void main(String[] args) {
            ...
            dObj.genericsMethod("Per scholas");//passing string through
            dObj.genericsMethod(2563.5);//passing float through
            dObj.genericsMethod('H');//passing char through
        }
        public class MyRunner {
            public static void main(String[] args) {
